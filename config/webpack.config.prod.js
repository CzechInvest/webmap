...
module.exports = {
  ...
  plugins: [
    ...
    // for your JavaScript to execute in the browser.
    // In comparison, tools like Closure Compiler and RollupJS ‘hoist’ or concatenate
    // the scope of all your modules into one closure and allow
